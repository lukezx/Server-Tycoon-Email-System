...
public class EmailManager : MonoBehaviour {
    ...
    {
        template = JsonUtility.FromJson<EmailTemplate>(File.ReadAllText("D:/unity/Projects/Email System 2.0/Assets/EmailTemplates/email"+ Random.Range(1,4).ToString() + ".json"));
